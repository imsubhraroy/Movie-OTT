      ...
      <div className="w-full h-[450px] bg-[#04152d] flex items-center relative md:h-[700px] px-4">
        ...
        <ContentWrapper>
          ...
          <div className="flex flex-col items-center text-white text-center relative max-w-[800px] mt-0 mb-0 ml-auto mr-auto">
            <span className="text-[30px] font-bold mb-[10px] md:mb-0 md:text-[50px]">Welcome.</span>
            ...
            <div className="flex items-center w-full">
              ...
              />
              <button className="w-[100px] h-[40px] search-button text-white outline-0 border-0 rounded-r-3xl text-[16px] cursor-pointer md:w-[150px] md:h-[45px] md:text-[18px]">Search</button>
            </div>
          </div>
        </ContentWrapper>
      </div>
